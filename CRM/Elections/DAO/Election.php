    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'visibility_start_date' => [
          ...
          'description' => 'Election visibility start date',
          'import' => TRUE,
        ...
        'visibility_end_date' => [
          ...
          'description' => 'Election visibility end date',
          'import' => TRUE,
        ...
        'nomination_start_date' => [
          ...
          'description' => 'Election nomination start date',
          'import' => TRUE,
        ...
        'nomination_end_date' => [
          ...
          'description' => 'Election nomination end date',
          'import' => TRUE,
        ...
        'advertise_candidates_date' => [
          ...
          'description' => 'Date from when candidates are available for viewing.',
          'import' => TRUE,
        ...
        'voting_start_date' => [
          ...
          'description' => 'Election voting start date',
          'import' => TRUE,
        ...
        'voting_end_date' => [
          ...
          'description' => 'Election voting end date',
          'import' => TRUE,
        ...
        'result_date' => [
          ...
          'description' => 'Election result date, after this date election results are published.',
          'import' => TRUE,
        ...
        'result_status' => [
          ...
          'description' => 'Election result status,  for admins to manage election result visibility manually.',
          'import' => TRUE,
        ...
        'is_deleted' => [
          ...
          'description' => 'Boolean field to soft delete an election.',
          'export' => TRUE,
        ...
        'is_visible' => [
          'name' => 'is_visible',
          'type' => CRM_Utils_Type::T_BOOLEAN,
          'description' => 'Boolean field to set if election is visible or not.',
          'export' => TRUE,
        ...
        'has_results_generated' => [
          ...
          'description' => 'Boolean field to set if results are generated.',
          'export' => TRUE,
        ...
        'anonymize_votes' => [
          ...
          'description' => 'Boolean field to anonymize votes when results are generated.',
          'export' => TRUE,
        ...
        'allow_revote' => [
          ...
          'description' => 'Boolean field to set if members are allowed to re-vote in election.',
          'export' => TRUE,
        ...
        'required_nominations' => [
          ...
          'description' => 'Number of required nominations to become eligible candidate.',
          'import' => TRUE,
        ...
        'created_at' => [
          ...
          'title' => ts('Created At'),
          'description' => 'Date on which election created.',
          'export' => TRUE,
        ...
        'updated_at' => [
          ...
          'type' => CRM_Utils_Type::T_TIMESTAMP,
          'title' => ts('Updated At'),
          'description' => 'Date on which election was updated.',
          'required' => FALSE,
          'export' => TRUE,
        ...
        'created_by' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'title' => ts('Created By'),
          'description' => 'FK to Contact who created particular election',
          'table_name' => 'civicrm_election',
          'entity' => 'Election',
          'bao' => 'CRM_Elections_DAO_Election',
