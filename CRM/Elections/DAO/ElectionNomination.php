    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'description' => 'Unique ElectionNomination ID',
          'required' => TRUE,
        ...
        'is_eligible_candidate' => [
          ...
          'description' => 'Boolean field to identity if nomination is a valid candidate.',
          'import' => TRUE,
        ...
        'has_accepted_nomination' => [
          ...
          'description' => 'Boolean field to identity if nomination has been accepted by candidate.',
          'import' => TRUE,
        ...
        'has_rejected_nomination' => [
          ...
          'description' => 'Boolean field to identity if nomination has been rejected by candidate.',
          'import' => TRUE,
        ...
        'created_at' => [
          ...
          'title' => ts('Created At'),
          'description' => 'Date on which election nomination created.',
          'export' => TRUE,
        ...
        'updated_at' => [
          ...
          'type' => CRM_Utils_Type::T_TIMESTAMP,
          'title' => ts('Updated At'),
          'description' => 'Date on which election nomination was updated.',
          'required' => FALSE,
          'export' => TRUE,
        ...
        'member_nominee' => [
          ...
          'description' => 'FK to Contact for which this nomination is added.',
          'table_name' => 'civicrm_election_nomination',
          'entity' => 'ElectionNomination',
          'bao' => 'CRM_Elections_DAO_ElectionNomination',
        ...
        'election_position_id' => [
          ...
          'description' => 'FK to ElectionPosition for which this nomination is added.',
          'table_name' => 'civicrm_election_nomination',
