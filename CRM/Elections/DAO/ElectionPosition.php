    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'description' => 'Unique ElectionPosition ID',
          'required' => TRUE,
        ...
        'quantity' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'title' => ts('Quantity'),
          'description' => 'Quantity of a this position.',
          'import' => TRUE,
        ...
        'sortorder' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'title' => ts('Order'),
          'description' => 'Order of this position.',
          'import' => TRUE,
        ...
        'created_at' => [
          ...
          'title' => ts('Created At'),
          'description' => 'Date on which election position created.',
          'export' => TRUE,
        ...
        'updated_at' => [
          ...
          'type' => CRM_Utils_Type::T_TIMESTAMP,
          'title' => ts('Updated At'),
          'description' => 'Date on which election position was updated.',
          'required' => FALSE,
          'export' => TRUE,
        ...
        'created_by' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'title' => ts('Created By'),
          'description' => 'FK to Contact who created particular position',
          'table_name' => 'civicrm_election_position',
          'entity' => 'ElectionPosition',
        ...
        'result_status' => [
          ...
          'description' => 'Result status for this position.',
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
          'import' => TRUE,
