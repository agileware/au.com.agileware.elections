...
class api_v3_ElectionVoteTest extends api_v3_ElectionBaseTestCase {
  ...
  public function testAddVotesWithoutParams() {
    $this->callAPIFailure('ElectionVote', 'create', []);
  }
  ...
  public function testAddVotesAfterVotingStarted() {
    ...
    CRM_Core_DAO::executeQuery('UPDATE civicrm_election SET voting_start_date = %1 WHERE id = %2', [
      1 => [$today->format('Y-m-d H:i:s'), 'String'],
      2 => [$election['id'], 'Integer'],
    ]);
  ...
  public function testAddVotesAfterVotingEnds() {
    ...
    CRM_Core_DAO::executeQuery('UPDATE civicrm_election SET voting_end_date = %1 WHERE id = %2', [
      1 => [$today->format('Y-m-d H:i:s'), 'String'],
      2 => [$election['id'], 'Integer'],
    ]);
